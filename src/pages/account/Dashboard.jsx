    ...
    <div>
      ...
      {activeTab === 'bookings' && (
        <div>
          ...
          {/* My Orders Prompt */}
          <div style={{ marginTop: '2.5rem', marginBottom: '1.5rem', padding: '1.25rem 1.5rem', background: '#FFFDF9', border: '1px solid rgba(227, 211, 184, 0.7)', borderRadius: '6px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
            <div>
              <strong style={{ color: 'var(--cocoa-deep)', fontSize: '0.98rem' }}>Café Takeout &amp; Boutique Orders</strong>
              <div style={{ fontSize: '0.84rem', color: 'var(--taupe)', marginTop: '2px' }}>
                Track live preparation, pickup status, and purchase receipts on your dedicated orders page.
              </div>
            </div>
            <Link to="/account/orders" className="btn btn-outline" style={{ fontSize: '0.82rem', padding: '8px 16px' }}>
              Go to My Orders →
            </Link>
          </div>
